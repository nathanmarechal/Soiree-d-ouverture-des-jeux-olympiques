  ...
  <div class="billetterie-image-container">
    ...
    <div class="billetterie-overlay-text">
      <div class="billetterie-text-content">
        ...
        <button class="billetterie-overlay-button">Cliquez ici</button>
      </div>
    </div>
  </div>
</template>
...
<style scoped>
.billetterie-image-container {
  position: relative;
  height: 100vh;
  overflow: hidden;
}

.billetterie-image-container img {
  object-fit: cover;
}

.billetterie-overlay-text {
  position: absolute;
  top: 50%;
  left: 0;
...
.billetterie-overlay-button:hover {
