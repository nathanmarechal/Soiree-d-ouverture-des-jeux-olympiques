  ...
  <div class="drink-image-container">
    ...
    <div class="drink-overlay-text">
      <div class="drink-text-content">
        ...
        <button class="drink-overlay-button">Cliquez ici</button>
      </div>
    </div>
  </div>
</template>
