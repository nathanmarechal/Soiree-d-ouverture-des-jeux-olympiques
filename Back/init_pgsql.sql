...
-- Query to select data from the utilisateur table
SELECT * FROM utilisateur;

SELECT * FROM utilisateur WHERE id_user = 1;

SELECT * FROM utilisateur WHERE LENGTH(prenom) = (SELECT MAX(LENGTH(prenom)) FROM utilisateur);

SELECT *
FROM utilisateur
WHERE LENGTH(prenom) = (SELECT MAX(LENGTH(prenom)) FROM utilisateur);